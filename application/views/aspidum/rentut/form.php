...
<?php  echo form_open_multipart('aspidum/rentut/tambah/'.$this->uri->segment(4),array('class'=>"form-horizontal",'method'=>'POST','id'=>"form_nodis")); ?>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
          ...
          <div class="box-footer">
            <button <?php if($data[0]['posisi']>5){echo "disabled";} ?> class="btn btn-success pull-right" type="submit">Simpan</button>
          </div>
        </div>
