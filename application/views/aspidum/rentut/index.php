...
<div class="content-wrapper">
    ...
    <section class="invoice">
      ...
      <div style="width: 100%;background-color: #edf2f0;color: white;height: 25px;text-align: center;vertical-align: center;">
          <h3 style="font-size: 20px;color: #3e3f3f;"><center><strong>RENTUT YANG BELUM DIBERI USULAN</strong></center></h3>    
      </div> <br>
      <div class="row">
                ...
                <td>
                  <center>
                    <div class="tooltip-demo">
                      <a href="<?php echo base_url('aspidum/rentut/tambah/'.$this->Mcrypt->encrypt($dt['id_sop']));?>">
