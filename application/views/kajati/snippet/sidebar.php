    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li style="font-size: 12px;">
          <a  href="<?php echo base_url('kajati/beranda');?>">
            <i class="fa fa-home" aria-hidden="true"></i><span>Beranda</span>
          </a>
        </li>
        <li style="font-size: 12px;">
          <a href="<?php echo base_url('kajati/rentut/index');?>">
        ...
        <li style="font-size: 12px;">
          <a href="<?php echo base_url('kajati/rentut/usulan');?>">
            <i class="fa fa-user" aria-hidden="true"></i><span>Manajemen Usulan Rentut</span>
          </a>
        </li>
        <li style="font-size: 12px;">
          <a href="<?php echo base_url('kajati/rentut/form');?>">
