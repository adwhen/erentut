...
<?php  echo form_open_multipart('kajati/rentut/tambah/'.$this->uri->segment(4),array('class'=>"form-horizontal",'method'=>'POST','id'=>"form_nodis")); ?>
  ...
  <div class="col-md-10">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false">Kajari</a></li>
        <li class=""><a href="#tab_5" data-toggle="tab" aria-expanded="false">Aspidum</a></li>
      </ul>
      <div class="tab-content">
        ...
        <div class="tab-pane" id="tab_4">
          <div class="box-body">
            <div class="col-md-12" style="background-color: #00a65a;margin-bottom: 20px;color:white;"><center><label class="control-label">Rencana Tuntutan Pidana Oleh Kajari</label></center></div>
            <br>
            <div class="form-group">
              <label class="col-sm-2 control-label">Pidana Pokok</label>

              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($kajari[0]['pidana_pokok'])){echo $kajari[0]['pidana_pokok'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Pidana Tambahan</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($kajari[0]['pidana_tambahan'])){echo $kajari[0]['pidana_tambahan'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Tindakan</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($kajari[0]['tindakan'])){echo $kajari[0]['tindakan'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Barang Bukti</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($kajari[0]['bb_rentut'])){echo $kajari[0]['bb_rentut'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Biaya Perkara</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($kajari[0]['biaya_perkara'])){echo $kajari[0]['biaya_perkara'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Pendapat</label>
              ...
              <div class="col-sm-10">
                <textarea class="form-control" readonly=""><?php if(!empty($kajari[0]['pendapat'])){echo $kajari[0]['pendapat'];} ?></textarea>
              </div>
            </div>
          </div>
        </div>
        <div class="tab-pane" id="tab_5">
          <div class="box-body">
            <div class="col-md-12" style="background-color: #00a65a;margin-bottom: 20px;color:white;"><center><label class="control-label">Rencana Tuntutan Pidana Oleh Aspidum</label></center></div>
            <br>
            <div class="form-group">
              <label class="col-sm-2 control-label">Pidana Pokok</label>

              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($aspidum[0]['pidana_pokok'])){echo $aspidum[0]['pidana_pokok'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Pidana Tambahan</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($aspidum[0]['pidana_tambahan'])){echo $aspidum[0]['pidana_tambahan'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Tindakan</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($aspidum[0]['tindakan'])){echo $aspidum[0]['tindakan'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Barang Bukti</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($aspidum[0]['bb_rentut'])){echo $aspidum[0]['bb_rentut'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Biaya Perkara</label>
              ...
              <div class="col-sm-10">
                <input class="form-control" readonly="" type="text" value="<?php if(!empty($aspidum[0]['biaya_perkara'])){echo $aspidum[0]['biaya_perkara'];} ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Pendapat</label>
              ...
              <div class="col-sm-10">
                <textarea class="form-control" readonly=""><?php if(!empty($aspidum[0]['pendapat'])){echo $aspidum[0]['pendapat'];} ?></textarea>
              </div>
            </div>
          </div>
        </div>
